  ...
  defaultType: 'panel',
	 ...
	 defaults: {
	  ...
	  }, 
	  {
		  ...
		  width: 850,
		  margin: '0 10 0 0',
		  html: '<ul><li>Einführung von papierloser Kommissionierung/innerbetrieblicher Logistik</li><li>Einführung neuer Lagerstrategien (Verdichtung etc.)</li><li>Erfassung von qualitätsrelevanten Daten (Sendung fotografieren, Ladesicherung)</li></ul>',
	  }, 
	  {
		  title: 'Unternehman',
		  width: 280,
		  ...
		  items: [
		  {
			  ...
			  width: 300,
			  height: 150,
			  src: 'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/122014/mit_grayred.png'
		  }]
	  },
	  {
		  title: 'Reifegrad',
		  ...
		  items: [
		  {
			  ...
			  columns: 1,
			  items: [
				{boxLabel: 'Basis-Lösung', name: 'cb-col-1', checked: true},
	...
	},
	{
		...
		height: 160,
		margin: '0 10 0 0',
		html: '<li>+ Arbeitserleichterung</li><li>+ planbare Arbeitsschritte</li><li>- Neuer Arbeitsalltag</li><li>- Transparenz des Mitarbeiters (Leistungsfähigkeit)</li>'
	},
	{
		...
		height: 160,
		margin: '0 10 0 0',
		html: '<li>Prozesse digital abgebildet</li><li>Weniger persönlicher Kontakt (informeller Austausch geht zurück / fehlt)</li>'
	},
	{
